...
The system SHALL reject configured file audit paths that are empty, whitespace-only, or untrimmed before writing audit records or falling back to non-file audit behavior.
